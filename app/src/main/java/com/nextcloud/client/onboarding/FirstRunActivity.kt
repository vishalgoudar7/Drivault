...
class FirstRunActivity :
    ...
    //     defaultViewThemeUtils = viewThemeUtilsFactory?.withDefaultSchemes()
    //     defaultViewThemeUtils?.platform?.themeStatusBar(this)
    // }
    ...
    private fun setupHostOwnServerTextView(isProviderOrOwnInstallationVisible: Boolean) {
        defaultViewThemeUtils?.platform?.colorTextView(binding.hostOwnServer, ColorRole.PRIMARY)
    ...
    companion object {
        ...
        val firstRun: Array<FeatureItem>
            get() = arrayOf(
                FeatureItem(R.drawable.drivault_logo,
                    R.string.first_run_1_text,
                    R.string.empty,
                    true,
                    false),
                // FeatureItem(R.drawable.drivault_logo, R.string.first_run_1_text, R.string.empty, true, false),
