...
public class FeatureFragment extends Fragment implements Injectable {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (item.shouldShowImage()) {
            ...
            if (image != null) {
                whatsNewImage.setImageDrawable(image);  // use icon as-is, no tint
            }
        }
//        if (item.shouldShowImage()) {
//            final Drawable image = ResourcesCompat.getDrawable(getResources(), item.getImage(), null);
//            if (image != null) {
//                whatsNewImage.setImageDrawable(
//                    viewThemeUtils.platform.tintDrawable(requireContext(), image, ColorRole.PRIMARY)
//                );
//            }
//        }
        ...
        if (item.shouldShowTitleText()) {
            ...
            whatsNewTitle.setTextColor(
                android.graphics.Color.parseColor("#40E095")
                                      );
//            viewThemeUtils.platform.colorTextView(whatsNewTitle, ColorRole.PRIMARY);
    ...
    private TextView generateTextView(String text, Context context,
        ...
        viewThemeUtils.platform.colorTextView(textView, ColorRole.PRIMARY);
