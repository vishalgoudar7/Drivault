...
import com.owncloud.android.ui.fragment.invite.InviteFriendsFragment
...
sealed class NavigatorScreen(val tag: String, val hasDrawer: Boolean = true) : Parcelable {
    ...
    @Parcelize
    object InviteFriends : NavigatorScreen(INVITE_FRIENDS_TAG)
    ...
    companion object {
        ...
        private const val INVITE_FRIENDS_TAG = "InviteFriends"
        ...
        fun fromTag(tag: String?): NavigatorScreen? = when (tag) {
            ...
            INVITE_FRIENDS_TAG -> InviteFriends
    ...
    fun menuItemId(): Int = when (this) {
        ...
        InviteFriends -> R.id.nav_invite_friends
    ...
    fun actionBarStyle(): Pair<ActionBarStyle, Int> = when (this) {
        ...
        InviteFriends -> ActionBarStyle.Plain to R.string.invite_friends_title
    ...
    fun toFragment(): Fragment = when (this) {
        ...
        InviteFriends -> InviteFriendsFragment()
